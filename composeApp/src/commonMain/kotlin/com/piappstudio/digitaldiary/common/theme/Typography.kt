...
/**
 * Typography system for Digital Diary App
 * Uses Material 3 typography guidelines with custom fonts
 */

// Define custom font families if needed
// For now, using system fonts but easily replaceable with custom fonts
